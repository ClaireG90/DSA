...
namespace DataAccess
{
    public class DAOrder : Connection
    {
        ...
        public IEnumerable<Order> getOrdersByAccountAndDates(int aID, DateTime dateFrom, DateTime dateTo)
        {
            return entities.Order.Where(o => o.AccountID == aID && o.DateOfOrder >= dateFrom && o.DateOfOrder <= dateTo && o.StatusID == 2);
        }

        public Order getOrderByDateAndAccount(int aID, DateTime date)
        {
            return entities.Order.SingleOrDefault(o => o.AccountID == aID && o.DateOfOrder == date);
        }
    }
}
